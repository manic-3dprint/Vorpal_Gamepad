// Modified June 2019 to support Hexapod Gamepad Android app
// You must replace the appIPaddress below with the ip address displayed in parens in the ScratchX section of the preferences page
// changes marked with %HGA%

////////////////////////////////////////////////////////////////////////////
///////////////////////////////// %HGA% ////////////////////////////////////
///// !!!CHANGE ME!!! /////
var appIPaddress = '???.???.???.???'; ///// put the ip address for your Android device here (displayed in parens in the ScratchX section of the preferences page)
///// !!!CHANGE ME!!! /////
var myurl = "http://"+appIPaddress+":8080/";

AndroidGamepadApp = function()
{
	console.log("myurl="+myurl);
	return {
		id:"gamepad",
		open:function(parms /* stopBits,bitRate,ctsFlowControl */, deviceOpenedCallback) {console.log("device.open");deviceOpenedCallback(this);},
		send:function(data_) {console.log("device.send");sendImpl(data_);},
		set_receive_handler:function(receiveHandler_) {console.log("device.set_receive_handler");this.receiveHandler = receiveHandler_;},
		close: function() {console.log("device.close");}
	};
}
...
function sendImpl(data_)
{
	byteArray = new Uint8Array( data_ );
	hexData = toHexString(byteArray);
	console.log("sendImpl: data_=",data_,",hexData=",hexData);
    $.ajax({
      url: myurl,
      type: "GET",
      dataType: "json",
      ...
      error: function (jqXHR, status, err) {
        // server error
        server_status = myurl + " server down";
        console.log("server error",myurl);
      }
    });
}
...
/////////////////////////////////////////////////
    ...
    **********************/
    ...
    device = AndroidGamepadApp(); ///// %HGA%

    ScratchExtensions.register("VorpalGamepadApp", descriptor, ext, {type: "serial"}); ///// %HGA%

    device.open({ stopBits: 0, bitRate: 9600, ctsFlowControl: 0 }, deviceOpenedCallback); ///// %HGA%
